...
# -*- coding: utf-8 -*-
#
# uniphy documentation build configuration file, created by
# sphinx-quickstart on Wed Oct 25 19:12:40 2017.
#
...
latex_documents = [
    (master_doc, 'uniphy.tex', 'uniphy Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'uniphy', 'uniphy Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'uniphy', 'uniphy Documentation',
     author, 'uniphy', 'One line description of project.',
     'Miscellaneous'),
]
